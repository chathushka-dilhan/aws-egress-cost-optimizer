# This module sets up the core AWS services for the egress cost optimization solution.
# It includes S3 buckets for data storage, IAM roles for service permissions, and CloudWatch log groups for monitoring.
# This module is designed to be reusable and parameterized for different environments.
